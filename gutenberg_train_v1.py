"""
Training loop for DisattentionFormer V1 on Gutenberg corpus (~85M params).
...
Outputs to checkpoints_gutenberg_v1/.
"""
...
# ---------------------------------------------------------------------------
# Configuration — 85M params on Gutenberg (word-level)
# ---------------------------------------------------------------------------
...
CONFIG = {
    ...
    "d_model": 512,
    "n_heads": 8,
    "n_layers": 8,       # 87.6M params (TensionFFN is heavier than standard FFN)
    "d_ff": 2048,
    "seq_len": 512,
    "dropout": 0.1,
    # training — scaled for larger model
    "epochs": 3,
    "batch_size": 4,
    "lr": 3e-4,
    "weight_decay": 0.1,
    ...
    "beta": 0.05,        # L_tension
    "gamma": 0.02,       # L_individuation
    # logging and saving
    "log_every": 100,
    "save_every": 5000,
    "checkpoint_dir": "checkpoints_gutenberg_v1",
}
